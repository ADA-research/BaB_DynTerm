from experiments.running_time_prediction.config import CONFIG_RUNNING_TIME_REGRESSION, \
    CONFIG_DYNAMIC_ALGORITHM_TERMINATION_APPENDIX, CONFIG_DYNAMIC_ALGORITHM_TERMINATION
...
if __name__ == '__main__':
    ...
    run_timeout_classification_experiments_from_config(CONFIG_DYNAMIC_ALGORITHM_TERMINATION_APPENDIX)
